...
PROMPT = (
    "Listen to this audio completely. It describes a dataset specification "
    "(number of rows, column names, and per-column statistics or rules). "
    ...
    '"allowed_values", "value_range" (each an object mapping column name to its value '
    "as stated in the audio; use {} if not mentioned), "
    '"correlation" (array; [] if not mentioned). '
    "Numbers must be plain JSON numbers exactly as spoken. Include only what the audio states."
)
